...
if __name__ == "__main__":
    ...
    # Restricted copy of ms-pred's data_scripts/pubchem/04_make_retrieval_lists.py:
    # only the nist20 test-split entries (we don't have a nist23 formula map,
    # and only need the test subset, not val). Run with cwd=vendor/ms-pred.
    compute_entries = [
